...
public class HorizontalWheelView extends View {
    ...
    private void readAttrs(AttributeSet attrs)
    {
        ...
        boolean showActiveRange = a.getBoolean(R.styleable.HorizontalWheelView_showActiveRange,DEFAULT_SHOW_ACTIVE_RANGE);
        ...
        onlyPositiveValues = a.getBoolean(R.styleable.HorizontalWheelView_onlyPositiveValues,DEFAULT_ONLY_POSITIVE_VALUES);
        a.recycle();
    }
